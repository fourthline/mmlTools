...
public class MMLFileTest extends FileSelect {
	...
	public final void testParse() {
		try {
			...
			// Track3
			assertEquals("MML@aba,,;", score.getTrack(1).getMML());
